...
(function() {
  var async, blocks, env, findLayouts, fs, getComponentViewPath, getRealPath, handlebars, layouts, renderFromRealPath, templateLoader, utils;
  ...
  renderFromRealPath = function(path, context, cb) {
    ...
    return utils.syncLike([
      function(next) {
        return templateLoader.fromPath(path, next);
      }, function(template, next) {
        return async["do"](template, context, next);
      }, function(result) {
        return cb(result);
      }
    ]);
  ...
  module.exports = {
    ...
    renderInline: function(templateStr, context, cb) {
      ...
      return async["do"](template, context, cb);
    }
  };
