...
(function() {
  var FileNotFoundError, blocks, env, findLayouts, fs, getComponentViewPath, getRealPath, handlebars, layouts, normalizePath, registerLayout, renderFromRealPath, templateLoader, _;
  ...
  fs.watch(env.viewsHome, function(evt, filename) {
    return console.log("file changed: ", evt, filename);
  });
