...
(function() {
  var FileNotFoundError, blocks, env, findLayouts, fs, getComponentViewPath, getRealPath, handlebars, layouts, normalizePath, registerLayout, renderFromRealPath, templateLoader, watch, _;
  ...
  watch(env.viewsHome, function(filePath) {
    var err;
