...
(function() {
  ...
  if (env !== "test") {
    commander.version("Jigglypuff version: 0.0.15").usage("[options] [file], file default: jiggly.json").option("-p, --port [port]", "Use the specified port, will override port config in config.json.");
